...
KEY_SCROLLLCOK = 0x84; // Keyboard Locking Scroll Lock
...
KEY_INT7 = 0x8d; // Keyboard International7
KEY_INT8 = 0x8e; // Keyboard International8
KEY_INT9 = 0x8f; // Keyboard International9
 ...
 * HHKB pro keymap
 */
KEYBOARD_ID = "gosopeak";
KEYBOARD_DESC = "Goso Peak Keyboard";
 ...
 *      | 4  | Home | shift | Z   | X   | C     | V   | B    | N   | M   | <   | >   | ?    | shift | ก่    |
 *      | 5  | End  | ctrl  | Win | alt | space | alt | ctrl | ก็  | ก้  | กๆ  | \   | del  |       |       |
 *      +----+----------------------------------------------------------------------------------------------+
 **/
...
keymaps = [
    [
        ...
        [ KEY_PAGEUP, KEY_GRAVE, KEY_1, KEY_2, KEY_3, KEY_4, KEY_5, KEY_6, KEY_7, KEY_8, KEY_9, KEY_0, KEY_MINUS, KEY_EQUAL ],
        [ KEY_PAGEDOWN, KEY_TAB, KEY_Q, KEY_W, KEY_E, KEY_R, KEY_T, KEY_Y, KEY_U, KEY_I, KEY_O, KEY_P,  KEY_LEFTBRACE, KEY_RIGHTBRACE ],
        [ KEY_INSERT, KEY_FN, KEY_A, KEY_S, KEY_D, KEY_F, KEY_G, KEY_H, KEY_J, KEY_K, KEY_L, KEY_SEMICOLON, KEY_APOSTROPHE, KEY_ENTER ],
        [ KEY_HOME, KEY_LEFTSHIFT, KEY_Z, KEY_X, KEY_C, KEY_V, KEY_B, KEY_N, KEY_M, KEY_COMMA, KEY_DOT, KEY_SLASH, KEY_RIGHTSHIFT, KEY_UP ],
        [ KEY_END, KEY_LEFTCTRL, KEY_LEFTMETA, KEY_LEFTALT, KEY_SPACE, KEY_RIGHTALT, KEY_RIGHTCTRL, KEY_LEFT,KEY_DOWN,KEY_RIGHT, KEY_BACKSLASH, KEY_DELETE, KEY_NONE, KEY_NONE ],
    ],
    [
